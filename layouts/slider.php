<!-- Slider Section
		<section id="slider">
			<div class="slider-container">
				<div class="overlay">
					 <?php /* echo do_shortcode('[rev_slider alias="parallax_slider"]'); */?> 
				</div> /.overlay 
			</div>/.slider-container 
		</section> /#slider 
		 Slider Section End -->
		 
		 <!-- here is revulation slider. to active this slider must uncomment the section and must uncomment the php section. -->
