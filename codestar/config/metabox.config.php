...
#creating a custom metabox 

$options[]    = array(
  'id'        => '_portfilo_options',
  'title'     => 'Custom Portfilo Options',
  'post_type' => 'portfolio',
  'context'   => 'normal',
  'priority'  => 'default',
  'sections'  => array(
	array(
		  'name'  => 'portfilo_sec',
		  'title' => 'Portfilo Image',
		  'icon'  => 'fa fa-cog',
		  'fields' => array(
			array(
			  'id'             => 'portfilo_sec_field',
			  'type'           => 'select',
			  ...
			  'default_option' => 'Select an Image Size',
